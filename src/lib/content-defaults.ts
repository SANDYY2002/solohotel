// Seed content used the very first time the SiteContent table is empty,
// and merged underneath whatever is actually stored so new fields added
// in a future app update still have sane defaults for existing sites.
